    ...
    <table cellpadding="0" cellspacing="0" class="style1">
        ...
        <tr>
            <td>
                &nbsp;</td>
            <td class="style3">
                <asp:LinkButton ID="lnkbtndelstu" runat="server" onclick="lnkbtndelstu_Click">Delete Student Table</asp:LinkButton>
            </td>
            <td>
                &nbsp;</td>
            <td>
        ...
        <tr>
            <td>
                &nbsp;</td>
            <td class="style3">
                <asp:LinkButton ID="lnkbtnSPR" runat="server" onclick="lnkbtnSPR_Click">Student Password Recovery</asp:LinkButton>
            </td>
            <td>
                &nbsp;</td>
            <td>
