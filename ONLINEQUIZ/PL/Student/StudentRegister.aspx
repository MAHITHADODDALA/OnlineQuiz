        ...
        <table cellpadding="0" cellspacing="0" class="style1">
            ...
            <tr>
                ...
                <td class="style2" width="400">
                    RE ENTER SECTION</td>
                <td width="400">
                    <asp:TextBox ID="txtresec" runat="server"></asp:TextBox>
                    <cc1:TextBoxWatermarkExtender ID="txtresec_TextBoxWatermarkExtender" 
                        runat="server" Enabled="True" TargetControlID="txtresec" 
                        WatermarkCssClass="watermark" WatermarkText="c1">
                    </cc1:TextBoxWatermarkExtender>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" 
                        ControlToValidate="txtresec" ErrorMessage="*" ForeColor="Red"></asp:RequiredFieldValidator>
                </td>
                <td width="200">
                    &nbsp;</td>
            </tr>
            ...
            <tr>
                ...
                <td width="400">
                    ...
                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" 
                        ControlToValidate="txtsphone" ErrorMessage="*" ForeColor="Red" 
