                            ...
                            <table class="style1">
                                <tr>
                                    ...
                                    <td width="500" style="text-align: left">
                                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                                             BorderStyle="None" BorderWidth="1px" Height="100px" 
                                            onpageindexchanging="GridView1_PageIndexChanging" PageSize="1" Width="100px">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:Label ID="Label13" runat="server" Font-Size="XX-Small" ForeColor="#C2C29E" 
                                ...
                                <tr>
                                    <td>
                                        <asp:RadioButton ID="RadioButton2" runat="server" GroupName="r1" 
                                            Visible="False" Font-Size="Large"   />
                                        <asp:Label ID="Label14" runat="server" Font-Size="XX-Small" ForeColor="#C2C29E" 
                                            Text="." Visible="False"></asp:Label>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:RadioButton ID="RadioButton3" runat="server" GroupName="r1" 
                                            Visible="False" Font-Size="Large"  />
                                        <asp:Label ID="Label15" runat="server" Font-Size="XX-Small" ForeColor="#C2C29E" 
                                            Text="." Visible="False"></asp:Label>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <asp:RadioButton ID="RadioButton4" runat="server" GroupName="r1" 
                                            Visible="False" Font-Size="Large"  />
                                        <asp:Label ID="Label16" runat="server" Font-Size="XX-Small" ForeColor="#C2C29E" 
                                            Text="." Visible="False"></asp:Label>
                                    </td>
                                    <td>
                                        &nbsp;</td>
                                ...
                                <tr>
                                    <td align="right">
                                        <asp:Button ID="btnskip" runat="server" onclick="btnskip_Click" Text="Previous" 
